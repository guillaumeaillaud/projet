<section>
    <h2>FORMULAIRE DE DECLARATION POUR ATTESTAION</h2>
    <form action="" method="POST">
        <input type="text" name="nom" required placeholder="votre nom">
        <input type="text" name="prenom" required placeholder="votre prenom">
        <textarea name="adress" cols="60" rows="6" required placeholder="votre adresse"></textarea>
        ...
        <label>
            <input type="radio" name="raison" required value="necessité medicale">
            <span>necessité medicale</span>
        </label>
        ...
        <button type="submit">enregistrer ma declaration</button>
